...
bool App::OnInit() {
	...
	// create cbuffer
	{
		...
		// setting viewport and scissor rect(描画領域)
		{
...
bool App::InitD3D()
{
	...
	// create z-stencil buffer
	{
		...
		resDesc.Alignment = 0;
		resDesc.Width = m_Width;  // サイズはView Descriptorと同じ
		resDesc.Height = m_Height;
		resDesc.DepthOrArraySize = 1;
		resDesc.MipLevels = 1;
		resDesc.Format = DXGI_FORMAT_D32_FLOAT; // D32のDはDepthのD
